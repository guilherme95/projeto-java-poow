...
<head>
  ...
  <style>
    <%@include file="resources/css/produtos.css"%>
  </style>
</head>
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="http://localhost:8080/Projeto/produtos">Produtos</a>
        </li>
        <li class="nav-item">
...
<form action="produto-controller" method="post">
  ...
  <div class="mb-3 col-md-3">
    ...
    <select class="form-select" id="loja" aria-label="Default select example" name="loja">
